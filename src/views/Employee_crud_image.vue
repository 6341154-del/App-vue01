<template>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr v-for="employee in employees" :key="employee.emp_id">
          ...
          <td>
            <span v-if="employee.active == 1">ปกติ
          </span>
          ...
          <div class="modal-body">
            <form @submit.prevent="saveEmployee">
              ...
              <div class="mb-3">
                ...
                <select v-model="editForm.department" type="text" class="form-control" required>
  ...
  <option value="Puschase">Puschase</option>
              ...
              <div class="mb-3">
                ...
                <select v-model="editForm.active" type="text" class="form-control" required>
  <option selected>Open this select menu</option>
